...
class _PolicyScreenState extends State<PolicyScreen> {
  ...
  static const List<String> _englishTitles = [
    ...
    'Auction conditions',
    'Prohibited and unlawful products',
  ];
  ...
  static const List<String> _englishContents = [
    ...
    'Users must not post, advertise, buy, sell or trade any product prohibited by Cambodian law.\n\n• Prohibited items include wildlife, protected species and unlawful wildlife products.\n• Weapons, ammunition, explosives and unlawfully controlled equipment are prohibited.\n• Narcotic drugs, controlled substances and prohibited plants, including cannabis, are prohibited unless expressly authorized by applicable law.\n• Stolen or counterfeit goods, banned chemicals and any other unlawful product are prohibited.\n• Sesan may immediately remove a listing, suspend or terminate an account, preserve relevant evidence and report suspected violations to the competent authorities.',
  ];
    ...
    _sections = [
      {
        ...
        'content': 'រាល់ការចូលប្រើប្រាស់ ឬប្រតិបត្តិការបញ្ជាទិញតាមរយៈកម្មវិធី សេសាន (Sesan) ត្រូវបានចាត់ទុកជាការបង្ហាញឆន្ទៈយល់ព្រមដោយស្របច្បាប់ នូវរាល់បទប្បញ្ញត្តិនៃកិច្ចសន្យាអេឡិចត្រូនិចនេះ។\n\n• អ្នកប្រើប្រាស់មានកាតព្វកិច្ចអនុវត្តតាមលក្ខខណ្ឌដែលបានកំណត់ទាំងអស់។\n• មិនអាចបដិសេធទំនួលខុសត្រូវតាមផ្លូវច្បាប់ក្នុងករណីមានការរំលោភបំពានឡើយ។\n• ការប្រើប្រាស់កម្មវិធីបន្តបន្ទាប់ ចាត់ទុកថាជាការយល់ព្រមចំពោះការកែប្រែណាមួយដែលកើតមានក្រោយពេលនោះ។',
        'icon': Icons.gavel,
      },
      {
        'number': '២',
        'title': 'យន្តការការពារប្រតិបត្តិការហិរញ្ញវត្ថុ',
        'content': 'ដើម្បីធានាសុវត្ថិភាពប្រាក់ និងការពារហានិភ័យនៃការបោកប្រាស់ កម្មវិធី សេសាន តម្រូវឱ្យអតិថិជនប្រតិបត្តិការតាមរយៈ "កន្ត្រកទំនិញ" និងប្រព័ន្ធទូទាត់មជ្ឈការរបស់កម្មវិធីតែប៉ុណ្ណោះ។\n\n• ការធានាសុវត្ថិភាព៖ ប្រាក់ប្រតិបត្តិការនឹងត្រូវរក្សាទុកក្នុងប្រព័ន្ធបច្ចេកវិទ្យាដែលមានសុវត្ថិភាពកម្រិតខ្ពស់។\n• សិទ្ធិដាក់ពាក្យបណ្ដឹង៖ អតិថិជនមានសិទ្ធិដាក់ពាក្យបណ្ដឹងបង្កកប្រាក់ក្នុងរយៈពេល ០៤ ថ្ងៃ ប្រសិនបើទំនិញខុសពីលក្ខណៈបច្ចេកទេសដែលបានប្រកាស។\n• ការលើកលែងទំនួលខុសត្រូវ៖ សេសាន មិនទទួលខុសត្រូវចំពោះការបាត់បង់ ឬជម្លោះដែលកើតចេញពីការទិញដូរក្រៅប្រព័ន្ធឡើយ។',
        'icon': Icons.account_balance_wallet,
      },
      {
        'number': '៣',
        'title': 'គោលការណ៍កម្រៃសេវា និងលក្ខខណ្ឌទូទាត់',
        'content': '• កម្រៃសេវាស្តង់ដារ៖ ប្រព័ន្ធនឹងកាត់កម្រៃសេវាគ្រប់គ្រងចំនួន ៧% នៃតម្លៃប្រតិបត្តិការសរុប សម្រាប់ការទិញតាមកន្ត្រក់។\n• ការរួចកម្រៃសេវា (០%)៖ ចំពោះទំនិញតម្លៃខ្ពស់ (ត្រាក់ទ័រ, ដ្រូន...) អ្នកលក់អាចប្រើមុខងារ "បិទកន្ត្រក់" ដើម្បីចៀសវាងការកាត់កម្រៃ ៧%។\n• ការបញ្ជាទិញ៖ ប្រសិនបើប៊ូតុងកន្ត្រក់មាន "ពណ៌ប្រផេះ" មានន័យថាអ្នកលក់បានបិទការទិញតាមប្រព័ន្ធ។ សូមចុចលើប៊ូតុង "ឆាត" ដើម្បីទាក់ទងទិញដោយផ្ទាល់។\n• ស្ថានភាពរង់ចាំ (Pending)៖ សម្រាប់ការទិញតាមប្រព័ន្ធ ប្រាក់នឹងត្រូវរក្សាទុកក្នុងស្ថានភាពរង់ចាំរយៈពេល ០៥ ថ្ងៃជាដាច់ខាត។\n• ការអនុម័តប្រាក់៖ បើគ្មានបណ្ដឹងក្នុងរយៈពេល ០៤ ថ្ងៃដំបូង ប្រាក់នឹងផ្ទេរចូលកាបូបលុយអ្នកលក់នៅថ្ងៃទី ០៦។\n• ការបង្វិលប្រាក់៖ ករណីបោះបង់ ប្រាក់នឹងបង្វិលក្រោយការកាត់កម្រៃរដ្ឋបាល។',
        'icon': Icons.payments,
      },
      {
        'number': '៤',
        'title': 'ទំនួលខុសត្រូវរបស់អ្នកលក់ និងទណ្ឌកម្មតាមផ្លូវច្បាប់',
        'content': '• កាតព្វកិច្ច៖ អ្នកលក់ត្រូវធានាភាពត្រឹមត្រូវនៃព័ត៌មានទំនិញ និងគុណភាពស្របតាមស្ដង់ដារដែលបានប្រកាស។\n• ការដាក់ទណ្ឌកម្ម៖ ការផ្ដល់ព័ត៌មានមិនពិត ឬភស្តុតាងក្លែងក្លាយ ជាបទល្មើសធ្ងន់ធ្ងរ។\n• សេសាន រក្សាសិទ្ធិបិទគណនីជាអចិន្ត្រៃយ៍ និងចាត់វិធានការតាមក្រមរដ្ឋប្បវេណី និងក្រមព្រហ្មទណ្ឌជាធរមាននៃព្រះរាជាណាចក្រកម្ពុជា។',
        'icon': Icons.assignment_ind,
      },
      {
        'number': '៥',
        'title': 'ឯកជនភាពទិន្នន័យ និងយន្តការដោះស្រាយជម្លោះ',
        'content': '• ការការពារទិន្នន័យ៖ ព័ត៌មានផ្ទាល់ខ្លួនត្រូវបានរក្សាជាការសម្ងាត់ ស្របតាមច្បាប់ស្ដីពីការការពារទិន្នន័យផ្ទាល់ខ្លួន។\n• យន្តការដោះស្រាយជម្លោះ៖ រាល់ជម្លោះដែលកើតឡើងក្នុងប្រព័ន្ធ ការសម្រេចរបស់រដ្ឋបាល សេសាន គឺជាយន្តការដោះស្រាយបឋមជាដាច់ខាត។\n• ករណីមិនអាចដោះស្រាយបាន ជម្លោះនឹងត្រូវបញ្ជូនទៅដោះស្រាយតាមនីតិវិធីច្បាប់ជាធរមាននៃព្រះរាជាណាចក្រកម្ពុជា។',
        'icon': Icons.security,
      },
      {
        'number': '៦',
        'title': 'ភស្តុភារកម្ម និងហានិភ័យដឹកជញ្ជូន',
        'content': '• ការវេចខ្ចប់៖ អ្នកលក់មានកាតព្វកិច្ចរៀបចំការវេចខ្ចប់ឱ្យបានត្រឹមត្រូវតាមបច្ចេកទេស។ ការខូចខាតដោយសារការវេចខ្ចប់មិនត្រឹមត្រូវ ជាបន្ទុករបស់អ្នកលក់ទាំងស្រុង។\n• ភស្តុតាងបញ្ជាក់៖ អ្នកដឹកជញ្ជូនត្រូវថតរូបភាពទុកជាភស្តុតាង នៅពេលប្រគល់ទំនិញដល់អតិថិជន ដើម្បីការពារការបដិសេធថាមិនបានទទួល។\n• ហានិភ័យ៖ ហានិភ័យបាត់បង់ ឬខូចខាតទំនិញក្នុងពេលដឹកជញ្ជូន ជាការទទួលខុសត្រូវរបស់ភាគីដឹកជញ្ជូន លុះត្រាតែមានភស្តុតាងផ្ទុយ។',
        'icon': Icons.local_shipping,
      },
      {
        'number': '៧',
        'title': 'អំណាចគ្រប់គ្រងព័ត៌មាន និងតម្លៃទីផ្សារ',
        'content': '• ការគ្រប់គ្រងតម្លៃ៖ កម្មវិធី សេសាន រក្សាសិទ្ធិក្នុងការស្នើឱ្យកែសម្រួលតម្លៃ ប្រសិនបើឃើញថាមានការបំប៉ោងតម្លៃខុសពីតម្លៃទីផ្សារពិតប្រាកដ។\n• ការដកចេញផលិតផល៖ រដ្ឋបាលមានសិទ្ធិដកចេញ ឬបិទផលិតផលណាដែលខុសច្បាប់ ដោយមិនត្រូវជូនដំណឹងជាមុន។\n• ព័ត៌មានមិនពិត៖ ផលិតផលណាដែលបង្ហោះព័ត៌មានមិនត្រឹមត្រូវ នឹងត្រូវដកចេញភ្លាម ហើយម្ចាស់ទំនិញអាចត្រូវដាក់ទណ្ឌកម្ម។',
        'icon': Icons.admin_panel_settings,
      },
      {
        'number': '៨',
        'title': 'វិធានការបង្កកគណនី និងការផាកពិន័យ',
        'content': '• វិធានការបង្កក៖ ក្នុងករណីមានពាក្យបណ្ដឹងជម្លោះដែលមិនទាន់ដោះស្រាយ រដ្ឋបាលមានសិទ្ធិបង្កកប្រាក់ក្នុងកាបូបលុយរបស់អ្នកលក់ជាបណ្ដោះអាសន្ន។\n• ទណ្ឌកម្មហិរញ្ញវត្ថុ៖ ការព្យាយាមបោកប្រាស់ ០៣ ដងឡើងទៅ នឹងត្រូវប្រឈមនឹងការផាកពិន័យ ឬការដកឈ្មោះចេញពីវេទិកាជាអចិន្ត្រៃយ៍។\n• ការប្ដឹងទៅតុលាការ៖ ក្នុងករណីជម្លោះធ្ងន់ធ្ងរ សេសាន រក្សាសិទ្ធិប្ដឹងទៅតុលាការដើម្បីស្វែងរកសំណងតាមផ្លូវច្បាប់។',
        'icon': Icons.block,
      },
      {
        'number': '៩',
        'title': 'ការការពារកម្មសិទ្ធិបញ្ញា និងអត្តសញ្ញាណវេទិកា',
        'content': '• សិទ្ធិរូបភាព៖ អ្នកលក់ត្រូវប្រើតែរូបភាពដែលជាកម្មសិទ្ធិស្របច្បាប់របស់ខ្លួន។ ការប្រើរូបភាពរបស់អ្នកដទៃដោយគ្មានការអនុញ្ញាត ជាការរំលោភបំពានកម្មសិទ្ធិបញ្ញា។\n• ការការពារម៉ាកសញ្ញា៖ ហាមដាច់ខាតការប្រើប្រាស់ឈ្មោះ ឬសញ្ញាសម្គាល់ "សេសាន" ក្នុងគោលបំណងកេងចំណេញ ឬធ្វើឱ្យសាធារណជនយល់ច្រឡំ។',
        'icon': Icons.copyright,
      },
      {
        'number': '១០',
        'title': 'ករណីប្រធានស័ក្តិ​ (Force Majeure)',
        'content': 'សេសាន ត្រូវបានលើកលែងទំនួលខុសត្រូវចំពោះការខកខានកាតព្វកិច្ចដែលបណ្ដាលមកពីហេតុការណ៍ក្រៅពីការគ្រប់គ្រងដូចជា៖\n\n• គ្រោះធម្មជាតិ (ព្យុះ ទឹកជំនន់ ភ្លើងឆេះ)\n• ជម្លោះប្រដាប់អាវុធ ឬបះបោរ\n• ការដាច់ចរន្តអគ្គិសនីឬបណ្ដាញទូរគមនាគមន៍ជាស្ថាប័ន\n• ការវាយប្រហារតាមប្រព័ន្ធព័ត៌មានវិទ្យា\n• ជំងឺឆ្លងដ៏ធ្ងន់ធ្ងរ ឬគ្រោះអនាម័យជាតិ\n\nក្នុងករណីទាំងនេះ សេសាន នឹងជូនដំណឹងដល់អ្នកប្រើប្រាស់ ហើយព្យាយាមស្ដារសេវាកម្មឱ្យបានឆាប់រហ័ស។',
        'icon': Icons.warning_amber,
      },
      {
        'number': '១១',
        'title': 'ការប្រឆាំងការលាងប្រាក់ និងសកម្មភាពខុសច្បាប់',
        'content': '• ការទប់ស្កាត់បទល្មើស៖ ហាមឃាត់ការប្រើប្រាស់កាបូបលុយក្នុងកម្មវិធីសម្រាប់សកម្មភាពលាងប្រាក់ ហិរញ្ញប្បទានភេរវករ ឬសកម្មភាពខុសច្បាប់ណាមួយ។\n• ការរាយការណ៍៖ គណនីណាដែលត្រូវបានសង្ស័យ នឹងត្រូវផ្អាកភ្លាម ហើយព័ត៌មានបានប្រគល់ជូនអាជ្ញាធរមានសមត្ថកិច្ច។\n• ការសហការផ្នែកច្បាប់៖ សេសាន នឹងផ្ដល់ព័ត៌មានពេញលេញដល់អាជ្ញាធរ ក្នុងករណីមានការស៊ើបអង្កេតផ្លូវការ។',
        'icon': Icons.shield,
      },
      {
        'number': '១២',
        'title': 'សិទ្ធិធ្វើវិសោធនកម្ម និងសុពលភាពបទប្បញ្ញត្តិ',
        'content': '• វិសោធនកម្ម៖ កម្មវិធី សេសាន រក្សាសិទ្ធិក្នុងការកែប្រែ ឬបន្ថែមបទប្បញ្ញត្តិនៃលក្ខខណ្ឌនេះតាមការចាំបាច់ ដោយជូនដំណឹងតាមរយៈ notification ឬ email ។\n• ការយល់ព្រមបន្ត៖ ការប្រើប្រាស់កម្មវិធីបន្តបន្ទាប់ ក្រោយការកែប្រែ ចាត់ទុកថាជាការយល់ព្រមចំពោះវិសោធនកម្មថ្មីដោយគ្មានលក្ខខណ្ឌ។\n• សុពលភាព៖ ប្រសិនបើបទប្បញ្ញត្តិណាមួយត្រូវបានកំណត់ថាមោឃ បទប្បញ្ញត្តិដែលនៅសល់នៅតែមានសុពលភាពពេញលេញ។',
        'icon': Icons.edit_note,
      },
      {
        'number': '១៣',
        'title': 'ភស្តុតាងឌីជីថល និងភស្តុតាងសក្ខីកម្ម',
        'content': '• ភស្តុតាងឌីជីថល៖ រូបភាពផលិតផល វីដេអូពេលបើកកញ្ចប់ ប្រវត្តិ chat ប្រវត្តិប្រតិបត្តិការ ត្រូវបានចាត់ទុកជាភស្តុតាងសក្ខីកម្មស្របច្បាប់ក្នុងការដោះស្រាយជម្លោះ។\n• ការថតរូប៖ អ្នកដឹកជញ្ជូន និងអ្នកទទួលទំនិញ ត្រូវបានលើកទឹកចិត្តឱ្យថតរូបភាពទុកជាភស្តុតាង ក្នុងអំឡុងពេលផ្ទេរទំនិញ។\n• ការច្រានចោលភស្តុតាង៖ ការបដិសេធចំពោះភស្តុតាងឌីជីថលដែលច្បាស់លាស់ នឹងមិនត្រូវបានទទួលស្គាល់ក្នុងដំណើរការដោះស្រាយជម្លោះឡើយ។',
        'icon': Icons.camera_alt,
      },
      {
        'number': '១៤',
        'title': 'លក្ខខណ្ឌមោឃភាពនៃប្រតិបត្តិការ',
        'content': '• ការប្រកាសមោឃភាព៖ រដ្ឋបាលមានសិទ្ធិប្រកាសមោឃភាពលើប្រតិបត្តិការណាដែលមានការបោកប្រាស់ ឬកេងចំណេញប្រព័ន្ធ។\n• ការបង្វិលប្រាក់៖ ប្រាក់នឹងត្រូវបង្វិលជូនអ្នកទិញ ក្រោយការកាត់កម្រៃរដ្ឋបាល ក្នុងរយៈពេល ០៧ ថ្ងៃធ្វើការ។\n• ករណីអ្នកលក់មានការក្លែងបន្លំ អ្នកលក់ត្រូវទទួលខុសត្រូវបង់ប្រាក់ទាំងអស់ រួមទាំងកម្រៃ និងការខូចខាតផ្សេងៗដែលបានកើតឡើង។',
        'icon': Icons.cancel,
      },
      {
        'number': '១៥',
        'title': 'ការបដិសេធការធានាគុណភាពទំនិញ',
        'content': 'កម្មវិធី សេសាន ដើរតួជាវេទិកាសម្របសម្រួលប្រតិបត្តិការប៉ុណ្ណោះ ហើយ មិនផ្ដល់ការធានាលើគុណភាព សុវត្ថិភាព ឬភាពស្របច្បាប់នៃទំនិញដែលបង្ហោះដោយអ្នកលក់ឡើយ។\n\n• រាល់ការខូចខាត ឬផលវិបាកដែលកើតចេញពីការប្រើប្រាស់ផលិតផល ជាទំនួលខុសត្រូវផ្ទាល់រវាងអ្នកទិញ និងអ្នកលក់ ស្របតាមក្រមរដ្ឋប្បវេណីជាធរមាន។\n• សេសាន នឹងដើរតួជាអន្ទាញក្នុងការជួយដោះស្រាយជម្លោះ ប៉ុន្តែមិនទទួលខុសត្រូវដោយផ្ទាល់ចំពោះគុណភាពនៃការពិពណ៌នាទំនិញឡើយ។',
        'icon': Icons.info_outline,
      },
      {
        'number': '១៦',
        'title': 'លក្ខខណ្ឌការដេញថ្លៃ (Auction)',
        'content': '• ការដេញថ្លៃមិនអាចដកវិញបានទេ នៅពេលដែលបានចុចបញ្ជាក់ការដេញថ្លៃរួច។\n• អ្នកឈ្នះត្រូវបង់ប្រាក់ក្នុងរយៈពេល ២៤ ម៉ោង បន្ទាប់ពីការដេញថ្លៃបានបញ្ចប់ បើមិនដូច្នោះ ការដេញថ្លៃនឹងត្រូវលុបចោល។\n• ថ្លៃសេវាដាក់ auction ១៥,០០០ ៛ (កញ្ចប់ធម្មតា ៤៨ ម៉ោង) និង ២៥,០០០ ៛ (Premium ៧២ ម៉ោង) មិនអាចបង្វិលវិញបានទេ។\n• Admin រក្សាសិទ្ធិលុប auction ណាដែលរំលោភគោលការណ៍ ដោយមិនជូនដំណឹងជាមុន ហើយថ្លៃសេវានឹងមិនត្រូវបានបង្វិលឡើយ។\n• ម្ចាស់ទំនិញ និងអ្នកឈ្នះត្រូវទំនាក់ទំនងគ្នាដើម្បីរៀបចំការទូទាត់ក្នុងរយៈពេលកំណត់។',
        'icon': Icons.gavel,
      },
      {
        'number': '១៧',
        'title': 'ទំនិញ និងសកម្មភាពហាមឃាត់',
        'content': 'អ្នកប្រើប្រាស់មិនត្រូវបង្ហោះ ផ្សព្វផ្សាយ ទិញ លក់ ឬជួញដូរទំនិញណាដែលច្បាប់នៃព្រះរាជាណាចក្រកម្ពុជាហាមឃាត់ឡើយ។\n\n• ហាមឃាត់សត្វព្រៃ ប្រភេទសត្វការពារ និងផលិតផលពីសត្វព្រៃដែលខុសច្បាប់។\n• ហាមឃាត់អាវុធ គ្រាប់រំសេវ គ្រឿងផ្ទុះ និងឧបករណ៍គ្រប់គ្រងដោយច្បាប់ដែលគ្មានការអនុញ្ញាត។\n• ហាមឃាត់គ្រឿងញៀន សារធាតុញៀន និងរុក្ខជាតិហាមឃាត់ រួមទាំងកញ្ឆា លើកលែងតែមានការអនុញ្ញាតច្បាស់លាស់ស្របតាមច្បាប់។\n• ហាមឃាត់ទំនិញលួច ទំនិញក្លែងក្លាយ សារធាតុគីមីហាមឃាត់ និងទំនិញខុសច្បាប់ដទៃទៀត។\n• សេសាន អាចលុបការបង្ហោះភ្លាមៗ ផ្អាក ឬបិទគណនី រក្សាទុកភស្តុតាងពាក់ព័ន្ធ និងរាយការណ៍ករណីសង្ស័យទៅអាជ្ញាធរមានសមត្ថកិច្ច។',
        'icon': Icons.block,
      },
    ];
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  _t(
                    'សូមអានប្រការទាំង ១៧ ឱ្យចប់ មុនពេលចុចយល់ព្រម។ ការយល់ព្រមមានសុពលភាពតាមច្បាប់ជាធរមានរបស់ព្រះរាជាណាចក្រកម្ពុជា។',
                    'Please read all 17 sections before accepting. Your acceptance has legal effect under the applicable laws of Cambodia.',
                  ),
                  style: TextStyle(
    ...
    return Center(
      child: Column(
        children: [
          ...
          Text(
            _t(
              'ធ្វើបច្ចុប្បន្នភាពចុងក្រោយ៖ ថ្ងៃទី ២១ ខែមេសា ឆ្នាំ ២០២៦',
          ...
          Text(
            _t(
              ...
              '© 2026 Sesan Agriculture. All rights reserved.',
            ),
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    _t(
                      'ខ្ញុំបានអាន និងយល់ព្រមលើប្រការទាំង ១៧ ហើយទទួលស្គាល់ទំនួលខុសត្រូវស្របតាមច្បាប់ជាធរមាន។',
                      'I have read and accept all 17 sections and acknowledge my responsibilities under applicable law.',
                    ),
                    style: TextStyle(
                      fontSize: 12,
  ...
  Future<void> _acceptPolicy() async {
    try {
      ...
      if (uid == null || uid.isEmpty) {
        throw Exception(
          _t(
            'មិនអាចកំណត់អត្តសញ្ញាណអ្នកប្រើប្រាស់បានទេ។ សូមចូលប្រើប្រាស់គណនីឡើងវិញ។',
