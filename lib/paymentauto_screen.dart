    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text("ទឹកប្រាក់៖ $totalAmount ៛", style: const TextStyle(color: Colors.red, fontSize: 24, fontWeight: FontWeight.bold)),
            ...
            ElevatedButton(onPressed: _launchABA, child: const Text("បើក App ABA បង់លុយអូតូ")),
          ],
        ),
      ),
    );
