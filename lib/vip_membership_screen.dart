...
class _VipMembershipScreenState extends State<VipMembershipScreen> {
  ...
  Future<void> _downloadQR() async {
    try {
      ...
      if (!mounted) return;
      _showTopMessage(
        _t('❌ មិនអាចរក្សាទុក: $e', '❌ Could not save: $e'),
        isError: true,
      );
    }
  }
  ...
  Future<void> _submitVipRequest(
    ...
    if (!_formKey.currentState!.validate() || _receiptImage == null) {
      _showSnack(
        _t(
          'សូមបំពេញទិន្នន័យ និងភ្ជាប់រូបភាព',
          'Please complete the information and attach a receipt image.',
        ),
        isError: true,
      );
      return;
    ...
    try {
      ...
      try {
        final userDoc = await FirebaseFirestore.instance
            ...
            .get();
        if (userDoc.exists)
          sesanId = userDoc.data()?['sesan_id']?.toString() ?? '';
      } catch (_) {}
      ...
      if (mounted) {
        ...
        _showSnack(
          _t('✅ សំណើ VIP ត្រូវបានបញ្ជូន!', '✅ VIP request submitted!'),
          isError: false,
        );
      }
    } catch (e) {
      if (mounted)
        _showSnack(_t('❌ មានបញ្ហា: $e', '❌ Error: $e'), isError: true);
    } finally {
  ...
  Widget _buildVipCard(Map<String, dynamic> userData, String uid) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: amberColor.withOpacity(0.35),
            blurRadius: 24,
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        _vipCardInfo(
                          "VIP ID",
                          "VIP-${uid.substring(0, 5).toUpperCase()}",
                        ),
                      ],
                    ),
                    const SizedBox(height: 18),
    ...
    final benefits = [
      {
        ...
        'color': Colors.amber,
        'title': _t('ផ្លាកសញ្ញា VIP', 'VIP badge'),
        'desc': _t(
          'ផ្លាកពិសេសបង្ហាញលើប្រវត្តិរូប',
          'Special badge shown on your profile',
        ),
      },
      {
        'icon': Icons.bar_chart_rounded,
        'color': Colors.blueAccent,
        'title': _t('ស្ថិតិផ្ទាល់', 'Real-time stats'),
        'desc': _t(
          'មើលចំនួនអ្នកប្រើ ទំនិញ និងការបញ្ជាទិញ',
          'View users, products and orders in real time',
        ),
      },
      {
        'icon': Icons.show_chart,
        'color': Colors.greenAccent,
        'title': _t('ក្រាបទិន្នន័យ', 'Activity charts'),
        'desc': _t(
          'ក្រាបសកម្មភាពប្រចាំឆ្នាំ ៤ ខ្សែ',
          'Four annual activity charts',
        ),
      },
      {
        'icon': Icons.notifications_active,
        'color': Colors.orangeAccent,
        'title': _t('ការជូនដំណឹងមុនគេ', 'Priority notifications'),
        'desc': _t(
          'ទទួលព័ត៌មានពិសេសសម្រាប់ VIP',
          'Receive special VIP updates',
        ),
      },
      {
        'icon': Icons.support_agent,
        'color': Colors.purpleAccent,
        'title': _t('ជំនួយពិសេស', 'Priority support'),
        'desc': _t(
          'ការគាំទ្រផ្ទាល់ពីក្រុមការងារ',
          'Direct support from the Sesan team',
        ),
      },
    ];
    return Container(
          ...
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.diamond, color: amberColor, size: 20),
              ),
              const SizedBox(width: 12),
              Text(
                _t('អត្ថប្រយោជន៍ VIP', 'VIP benefits'),
                style: TextStyle(
                  color: Colors.amber,
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
            ...
            (b) => Padding(
              ...
              child: Row(
                children: [
                  ...
                  Icon(
                    Icons.check_circle,
                    color: (b['color'] as Color).withOpacity(0.7),
                    size: 16,
                  ),
                ],
              ),
      ...
      children: [
        Row(
          children: [
            ...
            Text(
              _t('សកម្មភាពប្រចាំឆ្នាំ', 'Annual activity'),
              style: TextStyle(
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(
              _t('ស្ថិតិថ្ងៃនេះ', "Today's stats"),
              style: TextStyle(
                color: Colors.white70,
                fontSize: 15,
                fontWeight: FontWeight.bold,
      ...
      bars.add(
        LineChartBarData(
          ...
          belowBarData: BarAreaData(
            show: true,
            color: lineColors[key]!.withOpacity(0.08),
          ),
        ),
      );
    }
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                _t('និន្នាការប្រចាំឆ្នាំ', 'Annual trends'),
                style: const TextStyle(
                  color: Colors.white70,
                  fontSize: 13,
                  fontWeight: FontWeight.bold,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    _t('ដោះសោទិន្នន័យពិសេស', 'Unlock exclusive data'),
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(
                      _t('ទិញ VIP ឥឡូវនេះ', 'Buy VIP now'),
                      style: const TextStyle(
                        fontFamily: 'Siemreap',
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
                  ...
                  Text(
                    _t(
                      'តម្លៃ ${formatter.format(vipPrice)} ៛ / ខែ',
                      'Price ${formatter.format(vipPrice)} KHR / month',
                    ),
                    style: TextStyle(
  ...
  void _showVipPurchaseDialog(BuildContext context) {
    int currentStep = 0;
          ...
          builder: (context, scrollController) => Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 20),
                Text(
                  _t('ក្លាយជាសមាជិក VIP', 'Become a VIP member'),
                  style: const TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                ...
                const SizedBox(height: 4),
                Text(
                  _t('ជំហាន ${currentStep + 1}/3', 'Step ${currentStep + 1}/3'),
                  style: TextStyle(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  _t(
                    'បំពេញព័ត៌មានដើម្បីបញ្ជាក់អត្តសញ្ញាណ',
  ...
  Widget _buildStep2(StateSetter setModalState) {
    return Column(
      children: [
          ...
          child: Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    _t('តម្លៃ VIP Membership', 'VIP Membership price'),
                    style: const TextStyle(
                      color: Colors.white60,
                      fontSize: 11,
                      fontFamily: 'Siemreap',
                  ...
                  const SizedBox(height: 4),
                  Text(
                    _t('សមាជិកភាព ១ ខែ', '1-month membership'),
                    style: const TextStyle(color: Colors.white54, fontSize: 10),
                  ),
                ],
              ),
              Text(
                "${formatter.format(vipPrice)} ៛",
                style: const TextStyle(
                  color: Colors.amber,
                  fontSize: 24,
                  fontWeight: FontWeight.bold,
        ...
        const SizedBox(height: 20),
        Text(
          _t('QR Code បង់ប្រាក់', 'Payment QR Code'),
          style: const TextStyle(
            color: Colors.white,
            fontWeight: FontWeight.bold,
            fontSize: 14,
        ...
        const SizedBox(height: 4),
        Text(
          _t('Long press ដើម្បីទាញ QR', 'Long press to save QR'),
  ...
  Widget _buildStep3(StateSetter setModalState) {
    return Column(
      children: [
        Container(
          padding: const EdgeInsets.all(14),
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  _t(
                    'ភ្ជាប់រូបថតវិក្កយបត្របង់ប្រាក់',
                    'Attach your payment receipt image',
                  ),
                  style: const TextStyle(
                    color: Colors.white70,
                    fontSize: 12,
            ...
            child: _receiptImage == null
                ? Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Text(
                        _t('ចុចដើម្បីជ្រើសរើស', 'Tap to select'),
                        style: TextStyle(
  ...
  Widget _stepDot(int step, int current) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: active
            ? (isCurrent ? accentColor : accentColor.withOpacity(0.7))
  ...
  Widget _stepLine(int step, int current) {
    return Expanded(
      child: Container(
        height: 2,
        decoration: BoxDecoration(
          gradient: step < current
              ? const LinearGradient(colors: [accentColor, Color(0xFF6B84FF)])
              : null,
      ...
      body: FutureBuilder<SharedPreferences>(
        ...
        builder: (context, prefsSnap) {
          ...
          if (uid.isEmpty) {
            return Center(
              child: Text(
                _t('សូមចូលប្រើគណនីដើម្បីបន្ត', 'Please log in to continue'),
                style: const TextStyle(
                  color: Colors.white70,
                  fontFamily: 'Siemreap',
                ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            style: ElevatedButton.styleFrom(
                              ...
                              elevation: 6,
                              shadowColor: amberColor.withOpacity(0.45),
                            ),
                            onPressed: () => _showVipPurchaseDialog(context),
                            icon: const Icon(Icons.diamond, size: 20),
                            label: Text(
                              _t(
                                'ចាប់ផ្ដើមជាសមាជិក VIP',
                                'Become a VIP member',
                              ),
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
