              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      '$quantity ${_stockLabel(context, (data['unit'] ?? '').toString())}',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: statusColor,
            ...
            child: Column(
              ...
              children: [
                ...
                if (data['reason'] != null &&
                  ...
                  Text(
                    _stockLabel(context, data['reason'].toString()),
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.grey[500],
                      fontFamily: 'Siemreap',
                                        ...
                                        return AlertDialog(
                                          ...
                                          actions: [
                                            ...
                                            ElevatedButton(
                                              ...
                                              child: Text(appText(context, km: 'យល់ព្រម', en: 'Confirm')),
                                            ),
                                          ],
                                        );
                                      },
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: isSaving
                      ...
                      try {
                        ...
                        _showSnack('${appText(context, km: '❌ មានបញ្ហា', en: '❌ Error')}: $e', Colors.red);
                      }
                    },
                    child: isSaving
                        ? const SizedBox(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                      isAdd ? appText(context, km: 'បន្ថែមស្តុក', en: 'Add stock') : appText(context, km: 'កាត់ស្តុក', en: 'Deduct stock'),
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        fontFamily: 'Siemreap',
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: isSaving
                      ...
                      int newQty = isAdd
                          ...
                          : currentQty - amount;
                      if (newQty < 0) {
                        _showSnack(appText(context, km: 'ស្តុកមិនគ្រប់គ្រាន់!', en: 'Insufficient stock!'), Colors.red);
                        return;
                      }
                      setModalState(() => isSaving = true);
                      try {
                        ...
                        _showSnack(
                          isAdd
                              ? '✅ ${appText(context, km: 'បន្ថែម', en: 'Added')} $amount ${_stockLabel(context, (data['unit'] ?? '').toString())}'
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                  appText(context, km: 'កាត់ស្តុក', en: 'Deduct stock'),
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: 'Siemreap',
                      ),
